    ...
    public static int PageAccess(NavigationManager? navManager, string pageName)
    {
        try
        {
            ...
            if (navManager == null || string.IsNullOrWhiteSpace(pageName))
            {
                ...
                Console.WriteLine("?? NavigationManager is null or pageName is empty — redirect skipped.");
                return -1;
            }
            ...
            if (MyPermissions == null || !MyPermissions.Any())
            {
                ...
                Console.WriteLine("?? Permissions not loaded yet for non-admin user.");
                navManager.NavigateTo("/", true);
                return -1;
            }
        ...
        catch (Exception ex)
        {
            ...
            Console.WriteLine($"?? PageAccess error: {ex.Message}");
