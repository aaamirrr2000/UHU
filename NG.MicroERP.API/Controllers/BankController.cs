...
public class BankController : ControllerBase
{
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(BankModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(BankModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(BankModel obj)
    {
