...
[ApiController]
[Authorize]
public class PartyContactsController : ControllerBase
{
    PartyContactsService Srv = new PartyContactsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PartyContactsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PartyContactsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PartyContactsModel obj)
    {
