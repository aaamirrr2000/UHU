...
[ApiController]
[Authorize]
public class CustomerItemDiscountRulesController : ControllerBase
{
    CustomerItemDiscountRulesService Srv = new CustomerItemDiscountRulesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(CustomerItemDiscountRulesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(CustomerItemDiscountRulesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(CustomerItemDiscountRulesModel obj)
    {
