...
[ApiController]
[Authorize]
public class EmployeesDevicesController : ControllerBase
{
    EmployeesDevicesService Srv = new EmployeesDevicesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(EmployeesDevicesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(EmployeesDevicesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(EmployeesDevicesModel obj)
    {
