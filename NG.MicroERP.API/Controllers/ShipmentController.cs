...
{
    ShipmentService Srv = new ShipmentService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ShipmentModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ShipmentModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ShipmentModel obj)
    {
