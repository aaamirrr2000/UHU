...
{
    SalaryService Srv = new SalaryService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(SalaryModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(SalaryModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(SalaryModel obj)
    {
