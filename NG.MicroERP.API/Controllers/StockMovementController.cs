...
{
    StockMovementService Srv = new StockMovementService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(StockMovementModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(StockMovementModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(StockMovementModel obj)
    {
