...
[ApiController]
[Authorize]
public class PurchaseOrderChargesController : ControllerBase
{
    PurchaseOrderChargesService Srv = new PurchaseOrderChargesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PurchaseOrderChargesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PurchaseOrderChargesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PurchaseOrderChargesModel obj)
    {
