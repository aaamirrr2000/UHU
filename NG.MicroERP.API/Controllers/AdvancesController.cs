...
{
    AdvancesService Srv = new AdvancesService();
    ...
    [HttpGet("GetAdvancesReport/{id}")]
    public async Task<IActionResult> GetAdvancesReport(int id)
    {
        var result = await Srv.GetAdvancesReport(id)!;
        if (result.Item1 == false)
            return NotFound("Record Not Found");
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(AdvancesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(AdvancesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(AdvancesModel obj)
    {
