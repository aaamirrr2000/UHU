...
{
    PurchaseOrderDetailsService Srv = new PurchaseOrderDetailsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PurchaseOrderDetailsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PurchaseOrderDetailsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PurchaseOrderDetailsModel obj)
    {
