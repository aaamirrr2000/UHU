...
[ApiController]
[Authorize]
public class TaxRuleDetailController : ControllerBase
{
    TaxRuleDetailService Srv = new TaxRuleDetailService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(TaxRuleDetailModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(TaxRuleDetailModel obj)
    {
