...
{
    ServiceChargesService Srv = new ServiceChargesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ServiceChargesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ServiceChargesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ServiceChargesModel obj)
    {
