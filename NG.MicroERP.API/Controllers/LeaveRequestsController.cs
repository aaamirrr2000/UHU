...
{
    LeaveRequestsService Srv = new LeaveRequestsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(LeaveRequestsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(LeaveRequestsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(LeaveRequestsModel obj)
    {
