...
[ApiController]
[Authorize]
public class FbrSubmissionController : ControllerBase
{
    FbrSubmissionService Srv = new FbrSubmissionService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(FbrSubmissionModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(FbrSubmissionModel obj)
    {
