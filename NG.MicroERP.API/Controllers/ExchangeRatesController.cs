...
{
    ExchangeRatesService Srv = new ExchangeRatesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ExchangeRatesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ExchangeRatesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ExchangeRatesModel obj)
    {
