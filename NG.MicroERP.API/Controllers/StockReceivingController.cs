...
{
    StockReceivingService Srv = new StockReceivingService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(StockReceivingModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(StockReceivingModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(StockReceivingModel obj)
    {
