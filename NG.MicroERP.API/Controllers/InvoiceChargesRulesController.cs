...
[ApiController]
[Authorize]
public class InvoiceChargesRulesController : ControllerBase
{
    InvoiceChargesRulesService Srv = new InvoiceChargesRulesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(InvoiceChargesRulesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(InvoiceChargesRulesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(InvoiceChargesRulesModel obj)
    {
