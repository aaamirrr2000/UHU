...
{
    ShiftsService Srv = new ShiftsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ShiftsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ShiftsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ShiftsModel obj)
    {
