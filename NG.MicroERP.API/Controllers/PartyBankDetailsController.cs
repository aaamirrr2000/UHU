...
[ApiController]
[Authorize]
public class PartyBankDetailsController : ControllerBase
{
    PartyBankDetailsService Srv = new PartyBankDetailsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PartyBankDetailsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PartyBankDetailsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PartyBankDetailsModel obj)
    {
