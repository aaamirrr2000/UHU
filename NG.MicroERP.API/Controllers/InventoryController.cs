...
public class InventoryController : ControllerBase
{
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(InventoryModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(InventoryModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(InventoryModel obj)
    {
