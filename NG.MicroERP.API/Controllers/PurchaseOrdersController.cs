...
{
    PurchaseOrdersService Srv = new PurchaseOrdersService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PurchaseOrdersModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PurchaseOrdersModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PurchaseOrdersModel obj)
    {
