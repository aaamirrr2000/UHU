...
{
    CategoriesService Srv = new CategoriesService();
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(CategoriesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(CategoriesModel obj)
    {
