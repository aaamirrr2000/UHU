...
{
    PermissionsService Srv = new PermissionsService();
    ...
    [HttpGet("SearchGroupPermissions/{OrganizationId}/{Criteria?}")]
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PermissionsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PermissionsModel obj)
    {
