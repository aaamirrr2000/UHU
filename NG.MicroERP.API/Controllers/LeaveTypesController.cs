...
{
    LeaveTypesService Srv = new LeaveTypesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(LeaveTypesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(LeaveTypesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(LeaveTypesModel obj)
    {
