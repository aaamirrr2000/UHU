...
{
    GroupsService Srv = new GroupsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(GroupsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(GroupsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(GroupsModel obj)
    {
