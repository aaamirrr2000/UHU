...
{
    LocationsService Srv = new LocationsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(LocationsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(LocationsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(LocationsModel obj)
    {
