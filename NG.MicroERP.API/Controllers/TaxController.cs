...
public class TaxController : ControllerBase
{
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(TaxModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(TaxModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(TaxModel obj)
    {
