...
{
    DepartmentsService Srv = new DepartmentsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(DepartmentsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(DepartmentsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(DepartmentsModel obj)
    {
