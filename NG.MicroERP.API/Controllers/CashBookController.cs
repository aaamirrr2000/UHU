...
{
    CashBookService Srv = new CashBookService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(CashBookModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(CashBookModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(CashBookModel obj)
    {
