...
[ApiController]
[Authorize]
public class ChargeRulesController : ControllerBase
{
    ChargeRulesService Srv = new ChargeRulesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ChargeRulesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ChargeRulesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ChargeRulesModel obj)
    {
