...
{
    TaxItemsService Srv = new TaxItemsService();
    ...
    [HttpGet("SearchTaxItemConfig/{Criteria?}")]
    public async Task<IActionResult> SearchTaxItemConfig(string Criteria = "")
    {
        var result = await Srv.SearchTaxItemConfig(Criteria)!;
        if (result.Item1 == false)
            return NotFound("Record Not Found");
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(TaxItemsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(TaxItemsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(TaxItemsModel obj)
    {
