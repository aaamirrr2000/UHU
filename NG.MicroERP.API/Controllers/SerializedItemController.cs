...
[ApiController]
[Authorize]
public class SerializedItemController : ControllerBase
{
    SerializedItemService Srv = new SerializedItemService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(SerializedItemModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(SerializedItemModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(SerializedItemModel obj)
    {
