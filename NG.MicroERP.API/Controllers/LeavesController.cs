...
{
    LeavesService Srv = new LeavesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(LeavesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(LeavesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(LeavesModel obj)
    {
