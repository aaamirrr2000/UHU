...
[ApiController]
[Authorize]
public class ScannerDevicesController : ControllerBase
{
    ScannerDevicesService Srv = new ScannerDevicesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ScannerDevicesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ScannerDevicesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ScannerDevicesModel obj)
    {
