...
/*──────────────────────────── SECURITY ─────────────────────────────*/
(250, 'Security', NULL, 'Control user access and permissions', NULL, 0, 'fa-solid fa-shield-halved', 5000, 1, 1, NULL, 1, NULL),
...
(409, 'Period Close', NULL, 'Manage accounting periods for GL posting', 'PeriodCloseDashboard', 400, 'fa-solid fa-calendar-month', 7390, 1, 1, NULL, 1, NULL);
