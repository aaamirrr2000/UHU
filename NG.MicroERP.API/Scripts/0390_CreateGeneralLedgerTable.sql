...
(
    ...
    CONSTRAINT FK_GeneralLedgerHeader_PostedToGLBy FOREIGN KEY (PostedToGLBy) REFERENCES dbo.Users(Id),
    ...
    CONSTRAINT FK_GeneralLedgerHeader_BaseCurrency FOREIGN KEY (BaseCurrencyId) REFERENCES dbo.Currencies(Id),
