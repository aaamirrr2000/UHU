...
{
    SystemConfigurationService Srv = new SystemConfigurationService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(SystemConfigurationModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(SystemConfigurationModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(SystemConfigurationModel obj)
    {
