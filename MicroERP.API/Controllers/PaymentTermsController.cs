...
{
    PaymentTermsService Srv = new PaymentTermsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PaymentTermsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PaymentTermsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PaymentTermsModel obj)
    {
