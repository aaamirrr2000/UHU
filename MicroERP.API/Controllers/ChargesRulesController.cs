...
[ApiController]
[Authorize]
public class ChargesRulesController : ControllerBase
{
    ChargesRulesService Srv = new ChargesRulesService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(ChargesRulesModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(ChargesRulesModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(ChargesRulesModel obj)
    {
