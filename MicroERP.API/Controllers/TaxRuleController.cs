...
{
    TaxRuleService Srv = new TaxRuleService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(TaxRuleModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(TaxRuleModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(TaxRuleModel obj)
    {
