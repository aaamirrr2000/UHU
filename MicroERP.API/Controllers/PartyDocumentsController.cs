...
[ApiController]
[Authorize]
public class PartyDocumentsController : ControllerBase
{
    PartyDocumentsService Srv = new PartyDocumentsService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(PartyDocumentsModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(PartyDocumentsModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(PartyDocumentsModel obj)
    {
