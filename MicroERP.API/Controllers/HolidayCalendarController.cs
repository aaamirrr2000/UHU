...
{
    HolidayCalendarService Srv = new HolidayCalendarService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(HolidayCalendarModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(HolidayCalendarModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(HolidayCalendarModel obj)
    {
