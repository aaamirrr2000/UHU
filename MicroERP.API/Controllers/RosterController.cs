...
{
    RosterService Srv = new RosterService();
    ...
    [HttpPost("Insert")]
    public async Task<IActionResult> Insert(RosterModel obj)
    {
    ...
    [HttpPost("Update")]
    public async Task<IActionResult> Update(RosterModel obj)
    {
    ...
    [HttpPost("SoftDelete")]
    public async Task<IActionResult> SoftDelete(RosterModel obj)
    {
