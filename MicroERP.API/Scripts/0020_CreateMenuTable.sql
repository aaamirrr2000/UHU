...
(165, 'Financial Reports', 'FINANCIAL REPORT', 'Trial balance, P&L, balance sheet, account analysis', 'ReportsPage', 150, 'fa-solid fa-file-invoice-dollar', 3005, 1, 1, NULL, 1, NULL),
(166, 'Sales Reports', 'SALES REPORT', 'Sales and invoice reports', 'ReportsPage', 150, 'fa-solid fa-chart-line', 3010, 1, 1, NULL, 1, NULL),
(167, 'Other Reports', 'OTHER REPORT', 'Cash movement, employee advance, party receivables and other reports', 'ReportsPage', 150, 'fa-solid fa-folder-open', 3015, 1, 1, NULL, 1, NULL),
(168, 'Operational Reports', 'OPERATIONAL REPORT', 'Daily funds, inventory, cash by location, reconciliation', 'ReportsPage', 150, 'fa-solid fa-calendar-day', 3020, 1, 1, NULL, 1, NULL),
(153, 'Daily Funds Closing', NULL, 'Daily cash and funds closing summary', 'DailyFundsClosingReport', 168, 'fa-solid fa-calendar-day', 3030, 1, 1, NULL, 1, NULL),
(154, 'Inventory Closing', NULL, 'Daily inventory closing summary', 'InventoryClosingReport', 168, 'fa-solid fa-boxes', 3040, 1, 1, NULL, 1, NULL),
(155, 'Cash by Location/User', NULL, 'Cash holdings by location and user', 'CashByLocationUserReport', 168, 'fa-solid fa-map-marked-alt', 3050, 1, 1, NULL, 1, NULL),
(156, 'Inventory by Location', NULL, 'Current inventory levels by location', 'InventoryByLocationReport', 168, 'fa-solid fa-warehouse', 3060, 1, 1, NULL, 1, NULL),
(157, 'Trial Balance', NULL, 'Trial balance as of selected date', 'TrialBalanceReport', 165, 'fa-solid fa-balance-scale', 3070, 1, 1, NULL, 1, NULL),
(158, 'Account Analysis', NULL, 'Detailed account analysis', 'AccountAnalysisReport', 165, 'fa-solid fa-chart-bar', 3080, 1, 1, NULL, 1, NULL),
(159, 'Profit & Loss', NULL, 'Income statement for selected period', 'ProfitLossReport', 165, 'fa-solid fa-chart-line', 3090, 1, 1, NULL, 1, NULL),
(160, 'Balance Sheet', NULL, 'Balance sheet as of selected date', 'BalanceSheetReport', 165, 'fa-solid fa-file-invoice-dollar', 3100, 1, 1, NULL, 1, NULL),
(161, 'Cash Reconciliation', NULL, 'Reconcile cash transactions against physical cash count', 'CashReconciliationReport', 167, 'fa-solid fa-balance-scale', 3110, 1, 1, NULL, 1, NULL),
(162, 'Employee Advance Report', NULL, 'View outstanding employee advances from cashbook', 'EmployeeAdvanceReport', 167, 'fa-solid fa-user-clock', 3120, 1, 1, NULL, 1, NULL),
(163, 'Cash Movement Report', NULL, 'View cash receipts and payments over time period', 'CashMovementReport', 167, 'fa-solid fa-money-bill-transfer', 3130, 1, 1, NULL, 1, NULL),
(164, 'Party Receivable/Payable Report', NULL, 'View outstanding receivables and payables by party', 'PartyReceivablePayableReport', 165, 'fa-solid fa-hand-holding-usd', 3140, 1, 1, NULL, 1, NULL),
...
(408, 'Services & Discounts', NULL, 'Configure service and discount charges for sale invoices', 'ChargesRulesDashboard', 400, 'fa-solid fa-concierge-bell', 7380, 1, 1, NULL, 1, NULL),
...
-- Ensure menu target is current (e.g. after renaming InvoiceChargesRules to ChargesRules)
UPDATE Menu SET PageName = 'ChargesRulesDashboard' WHERE PageName = 'InvoiceChargesRulesDashboard';
